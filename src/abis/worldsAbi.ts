export const worldsAddress = "0x2051Fe3596caB7f5A1D93913CcE4aA0E0399779c";

export const worldsAbi = [
  ...
  { inputs: [], name: "BeforeSaleStart", type: "error" },
  { inputs: [], name: "ExceedsMaxSupply", type: "error" },
  { inputs: [], name: "ExceedsWhitelistAllowance", type: "error" },
